...
|用户,角色,菜单管理组件|cbb_userauth|192.168.140.155:45002|22224|成虎|cbb_userauth|
...
|--|--|--|--|--|--|--|
|Mysql|关系型数据库|192.168.140.155|49999|root|Summit2017|
|Redis|内存数据库|192.168.140.155|6379|无|无|
