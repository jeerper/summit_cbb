...
public interface QueryDao {
     ...
     *
     * @param index      索引
     * @param groupField 按照某个字段分组
     * @param maxField   求某个字段聚合函数最大值
     ...
     *
     * @param jSONObjectList 查询条件
     * @param index          索引
     * @param groupField     按照某个字段分组加排序 key: 字段 value:asc or desc
     * @param maxField       求某个字段聚合函数最大值
     * @param client         client 连接
     * @return 查询结果
     */
     ...
     * @param jSONObjectList 查询条件
     * @param index          索引
     * @param groupFieldJson 多个字段分组加排序 key: 字段 value:asc or desc
     * @param aggFieldJson   多个字段 按照需求求聚合结果 key:字段 value : MAX,MIN..etc
     * @param client         client连接
     * @return 查询结果
     */
     ...
     * @param index      索引
     * @param groupField 分组字段
     * @param sumField   求某个字段聚合函数总和
     * @param client     求某个字段聚合函数总和
     * @return 查询结果
     */
