 ...
 */
public class PU_TD_TRAFFIC_DOME_MOTOR_IN_BICYCLE_LANE_PARAMS extends Structure {
	/** \ufffd\ufffd\ufffd\u02b9\ufffd\ufffd */
	 ...
	 * C type : BOOL[(6)]
	 */
	public PU_TD_TRAFFIC_DOME_MOTOR_IN_BICYCLE_LANE_PARAMS(boolean bEnable, NativeLong ulSnapFrameNum, NativeLong ulSensitivity, NativeLong ulContinuousDuration, boolean abRelatedLane[]) {
		super();
	...
	public PU_TD_TRAFFIC_DOME_MOTOR_IN_BICYCLE_LANE_PARAMS(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends PU_TD_TRAFFIC_DOME_MOTOR_IN_BICYCLE_LANE_PARAMS implements Structure.ByReference {
		
	};
	public static class ByValue extends PU_TD_TRAFFIC_DOME_MOTOR_IN_BICYCLE_LANE_PARAMS implements Structure.ByValue {
