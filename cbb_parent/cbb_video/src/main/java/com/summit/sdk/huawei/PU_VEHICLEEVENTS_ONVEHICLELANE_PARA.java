 ...
 */
public class PU_VEHICLEEVENTS_ONVEHICLELANE_PARA extends Structure {
	/** \u0368\ufffd\ufffdID */
	...
	public PU_VEHICLEEVENTS_ONVEHICLELANE_PARA() {
		super();
	}
	 ...
	 */
	public PU_VEHICLEEVENTS_ONVEHICLELANE_PARA(NativeLong ulChannelId, boolean enEnable, boolean enSnapEnable, int unVehicleSensitivity, int unOccupiedTime, NativeLong ulAlarmTime, AERADTC_LIST stAreaList, PU_ALARM_TIME_PARA_LIST stGuardPlan, byte szReserved[]) {
		super();
	...
	public PU_VEHICLEEVENTS_ONVEHICLELANE_PARA(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends PU_VEHICLEEVENTS_ONVEHICLELANE_PARA implements Structure.ByReference {
		
	};
	public static class ByValue extends PU_VEHICLEEVENTS_ONVEHICLELANE_PARA implements Structure.ByValue {
