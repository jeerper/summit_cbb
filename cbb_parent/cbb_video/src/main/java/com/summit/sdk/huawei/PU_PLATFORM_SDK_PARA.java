...
public abstract class PU_PLATFORM_SDK_PARA extends Structure {
	...
	protected List<String > getFieldOrder() {
		return Arrays.asList("bEnable", "enSdkPlatformMode", "szDeviceId", "szPlatformIp", "szPlatformPort", "szBackupPlatformIp", "szBackupPlatformPort", "enConnectType", "ulMeshIndex");
	}
	/**
	 ...
	 * @param ulMeshIndex \ufffd\ufffd\ufffd\ufffd\ufffd\ufffd
	 */
	public PU_PLATFORM_SDK_PARA(boolean bEnable, int enSdkPlatformMode, byte szDeviceId[], byte szPlatformIp[], NativeLong szPlatformPort, byte szBackupPlatformIp[], NativeLong szBackupPlatformPort, int enConnectType, NativeLong ulMeshIndex) {
		super();
