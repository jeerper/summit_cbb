 ...
 * @author Dave Syer
 */
public class SummitWebResponseExceptionTranslator implements WebResponseExceptionTranslator<OAuth2Exception> {
    ...
    private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e) throws IOException {
        ...
        return new ResponseEntity<>(new SummitAuth2Exception(e.getMessage()), headers,
