...
public class UserInfoCache {
    ...
    public void setUserInfo(String userName, UserInfo userInfo) {
        try {
            ...
            redisTemplateWithUserInfo.opsForValue().set(CommonConstant.USER_INFO_CACHE_PREFIX + userName, userInfoString);
        } catch (Exception e) {
    ...
    public UserInfo getUserInfo(String userName) {
        try {
            String userInfoString = redisTemplateWithUserInfo.opsForValue().get(CommonConstant.USER_INFO_CACHE_PREFIX + userName);
